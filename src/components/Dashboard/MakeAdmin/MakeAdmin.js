    ...
    return (
        <div className="my-5">
            ...
            <form style={{marginLeft: "200px"}} onSubmit={handleSubmit(onSubmit)}>
                <input  className="w-75 p-3" type="email" {...register("email")} placeholder="Your Email" /> <br />
                <input  className="w-75 p-3 my-3" type="password" {...register("password")} placeholder="Password" /> <br />
